...
const SelectGame = () => {
  ...
  return (
    <div className='w-full h-screen flex flex-col justify-center gap-10 px-3 py-8'>
      ...
      <div onClick={() => navigate('/game')} className='bg-orange-200 rounded-md overflow-hidden'>
